...
The differences between annotation types are explained in the [Grafana Crash Course](https://grafana.com/docs/plugins/volkovlabs-echarts-panel/<PLUGINS_VERSION>/exploring-annotations/).
