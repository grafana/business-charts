...
| [`context.grafana.getValueFormat()`](https://grafana.com/docs/plugins/volkovlabs-echarts-panel/<PLUGINS_VERSION>/charts-function/context-parameters/#grafanagetvalueformat) | Function to interpolate variables. |
| [`context.grafana.formattedValueToString()`](https://grafana.com/docs/plugins/volkovlabs-echarts-panel/<PLUGINS_VERSION>/charts-function/context-parameters/#grafanaformattedvaluetostring) | Function to interpolate variables. |
